...
router.post('/signup/step1', authenticationToken, checkBlockedUser,  professionalController.startProfessionalSignup);

// Paso 2: Completar información profesional
router.post('/signup/step2', authenticationToken, checkBlockedUser,  professionalController.completeProfessionalInfo);

// Subir documentos KYC
router.post(
    '/kyc/upload',
    authenticationToken, checkBlockedUser,
    upload.fields([
...
router.get('/kyc/status', authenticationToken, checkBlockedUser, professionalController.getKYCStatus);

router.post('/update/location', authenticationToken, checkBlockedUser,  professionalController.updateProfessionalLocation);
...
router.get('/list/nearby', authenticationToken, checkBlockedUser, professionalController.getNearbyProfessionals);
